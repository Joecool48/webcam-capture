#############################################################################
# Makefile for building: webcam_capture
# Generated by qmake (3.1) (Qt 5.12.0)
# Project:  webcam_capture.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile webcam_capture.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = webcam_capture1.0.0
DISTDIR = /home/joey/webcam_capture/.tmp/webcam_capture1.0.0
LINK          = g++
...
SOURCES       = webcam_capture.cpp 
OBJECTS       = webcam_capture.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		webcam_capture.pro  webcam_capture.cpp
QMAKE_TARGET  = webcam_capture
DESTDIR       = 
...
webcam_capture:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: webcam_capture.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile webcam_capture.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents webcam_capture.cpp $(DISTDIR)/
...
webcam_capture.o: webcam_capture.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o webcam_capture.o webcam_capture.cpp
